...
unsigned int max_yaccel=0;
unsigned char kdx, kdy, ks, ki; //Feedback gains for x-axis of car, y-axis of car, steering, and integral
unsigned char accel_count, print_count, wait_count;
